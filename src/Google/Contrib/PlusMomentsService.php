 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $plusService = new PlusMomentsService(...);
 ...
 * @author Google, Inc.
 */
class PlusMomentsService extends Service {
  public $moments;
  /**
  ...
  public function __construct(Client $client) {
    ...
    $this->moments = new MomentsServiceResource($this, $this->serviceName, 'moments',
...
class MomentVerb extends Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
